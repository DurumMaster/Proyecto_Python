...
class FrameRegCompra(ttk.Frame):
     ...
     def create_widgets(self):
          ...
          self.label_titulo.grid(row=1, column=0, columnspan=3)
          ...
          self.btn_buscar = ttk.Button(self, text="🔍 BUSCAR", command=self.buscar, style="Accent.TButton")
          ...
          self.treeview = ttk.Treeview(self.frame_tabla, columns=("codigo", "nombre"), 
          ...
          self.treeview.column("codigo", anchor="w", width=100)
          self.treeview.column("nombre", anchor="w", width=200)
          ...
          self.entry_precio_total.grid(row=6, column=1, state="disabled", padx=5, pady=5, sticky="w")

          self.btn_registrar = ttk.Button(self, text="☁ REGISTRAR", style="Upload.TButton")
